...
var num9000: (Int, CistercianDrawing) = (9000, [.bottomLeftV, .bottomMiddleLeftH, .bottomLeftH])
var num900: (Int, CistercianDrawing) = (900, [.bottomRightV, .bottomMiddleRightH, .bottomRightH])
var num90: (Int, CistercianDrawing) = (90, [.topLeftV, .topMiddleLeftH, .topLeftH])
var num9: (Int, CistercianDrawing) = (9, [.topRightV, .topMiddleRightH, .topRightH])

num9000.0 // 9000
num9000.1.rawValue // 622592
num900.1.rawValue // 19456
num90.1.rawValue // 608
num9.1.rawValue // 19

num9000.1.rawValue >> 5 // 19456
num9000.1.rawValue >> 10 // 608
num9000.1.rawValue >> 15 // 19

var drawing: CistercianDrawing = [
        .topRightDiagDown, .topLeftDiagDown,
        .bottomRightDiagDown,
        .bottomLeftV, .bottomLeftH, .bottomMiddleLeftH] // 9433
drawing.rawValue // 630916
